...
//        configureConsoleLogging(Boolean.parseBoolean(args[0]));
        configureLogging(Boolean.parseBoolean(args[0]), logFilePath);
        logger.info(SEPARATOR);
        logger.info("Project properties are loaded. Log file generated for this run = " + logFilePath);
        logger.debug("This is the test statement. -> at current time = " + System.currentTimeMillis());
    }

    public static String configureLogging(boolean debug, String logFilePath) {
